define(function(require, exports, module) {
	...
	$(function() {
		...
		$.ajax( {
			...
			success : function(response) {
				...
				window.uSinaEmotionsHtMap=uSinaEmotionsHt;
			}
		});
	});

	//替换
	exports.analyticEmotion=function(s) {
	...
	(function($){
		...
		$.fn.SinaEmotion = function(target,options){
			var options = $.extend({},$.fn.SinaEmotion.option, options);
			var cat_current;
			var cat_page;
			$(this).click(function(event){
				...
				$('#emotions').html('<div style="float:right"><a href="javascript:void(0);" id="prev">&laquo;</a><a href="javascript:void(0);" id="next">&raquo;</a></div><div class="categorys"></div><div class="container" style="width:375px;"></div><div class="page"></div>');
			...
			function showEmotions(){
				...
				$('#emotions .container a').click(function(){
					...
					options.todo($(this).attr('title'),uSinaEmotionsHt);
					$('#emotions').remove();
				});
		...
		$.fn.SinaEmotion.option={
				todo:$.noop	
			};
	})($);
    module.exports = $.fn.SinaEmotion;
});
