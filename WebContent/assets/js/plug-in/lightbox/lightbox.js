	...
	(function() {
		...
		LightboxOptions = (function() {
			...
			function LightboxOptions() {
				this.fileLoadingImage = sysPath + '/assets/js/plug-in/lightbox/images/loading.gif';
				this.fileCloseImage = sysPath + '/assets/js/plug-in/lightbox/images/close.png';
		...
		Lightbox = (function() {
			...
			Lightbox.prototype.changeImage = function(imageNumber) {
				...
				preloader.onload = function() {
					...
					$image.width = preloader.width>800?800:preloader.width;
					$image.height = preloader.width>800?preloader.height/preloader.width*800:preloader.height;
					
					return _this.sizeContainer($image.width,
							$image.height);
				};
			...
			Lightbox.prototype.sizeContainer = function(imageWidth, imageHeight) {
				...
				containerTopPadding = parseInt($container.css('padding-top'),
						10);
				containerRightPadding = parseInt($container
						.css('padding-right'), 10);
				containerBottomPadding = parseInt($container
			...
			Lightbox.prototype.updateDetails = function() {
				...
				if (typeof this.album[this.currentImageIndex].title !== 'undefined'
					...
					$lightbox.find('.lb-caption').html(
							this.album[this.currentImageIndex].title).fadeIn(
							'fast');
				}
