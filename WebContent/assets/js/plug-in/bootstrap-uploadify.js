require(['jquery-msg','plug-in/swfobject'],function(msg){
	/*
	Uploadify v3.2
			...
			init : function(options, swfUploadOptions) {
				...
				return this.each(function() {
					...
					var settings = $.extend({
						...
						swf      : sysPath + '/assets/js/plug-in/uploadify.swf', // The path to the uploadify SWF file
						uploader : 'uploadify.php',  // The path to the server-side upload script
						
						// Options
						auto            : true,               // Automatically upload files when added to the queue
						buttonClass     : 'btn btn-small',                 // A class name to add to the browse button DOM object
					...
					if (flashInstalled) {
						...
						$button.html('<a class="'+ settings.buttonClass +'"><i class="'+settings.icon+'"></i>' + settings.buttonText + '</a>')
						.css({
							'height'      : settings.height + 'px',
							'width'       : settings.width + 'px'
						});
...
//						 this.button.validationEngine('showPrompt', this.queueData.errorMsg,'','topRight',true);
						msg({content : this.queueData.errorMsg});
					}
				}
			...
			onSelect : function(file) {
				...
				if (settings.itemTemplate == false) {
					settings.itemTemplate = '<div id="${fileID}" class="uploadify-queue-item">\
						<div class="cancel">\
							<a class="icon-remove" href="javascript:$(\'#${instanceID}\').uploadify(\'cancel\', \'${fileID}\')"></a>\
						</div>\
